...
import com.boscloner.bosclonerv2.home.HomeFragment.OnListFragmentInteractionListener;
...
public class HomeFragmentRecyclerViewAdapter extends RecyclerView.Adapter<HomeFragmentRecyclerViewAdapter.ViewHolder> {
    ...
    public HomeFragmentRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
